...
async def fetch_info(replied_user, event):
    ...
    if x == 1:
       ...
       caption += f"<b> 𓆩 𝙎𝙊𝙐𝙍𝘾𝞝 𝗩𝗘𝗕𝗧𝗛𝗢𝗡 𓆪 </b> - @VebThon "
...
async def who(event):
    ...
    if replied_user.id == 5191376406 or replied_user.id == 1895219306 or replied_user.id == 2095357462:
