...
async def fetch_info(replied_user, event):
    ...
    if x == 1:
       ...
       caption += f"<b> 𓆩 𝙎𝙊𝙐𝙍𝘾𝞝 𝗩𝗘𝗕 𓆪 </b> - @VebThon "
...
async def who(event):
    ...
    zel_dev = (5191376406, 54262739871)
    ...
    if replied_user.id == 5191376406 or replied_user.id == 6367373783 or replied_user.id == 23839374791:
