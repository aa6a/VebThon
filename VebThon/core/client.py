                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext = f"\nيتم تحميل هذا الملف فقط هنا ،\
                                  ...
                                  \n\nنحن نحترم خصوصيتك.\
                                  \n\nفقـط قـم بإعـادة توجيـه هـذه الرسـالة إلى مطـور السـورس @DevEviI\
                                  \n\n--------بـدء تتبـع سجـل فيبثـون  𝗩𝗘𝗕𝗧𝗛𝗢𝗡--------\
                        ...
                        ftext += "\n\n--------نهـاية سجـل تتبـع فيبثـون  𝗩𝗘𝗕𝗧𝗛𝗢𝗡--------"
                        ...
                        link = "[𝙈𝙊𝙃𝘼𝙈𝙈𝘼𝘿(https://t.me/DevEviI)"
                        text = (
                            "**✘ تقـريـر إشعـار فيبثـون  𝗩𝗘𝗕𝗧𝗛𝗢𝗡 ✘**\n\n"
            ...
            async def wrapper(check):
                try:
                    ...
                    if not disable_errors:
                        ...
                        text = "**✘ تقـريـر إشعـار فيبثـون  𝗩𝗘𝗕𝗧𝗛𝗢𝗡 ✘**\n\n "
                        link = "[𝘿𝙚𝙫𝙀𝙫𝙞𝙄(https://t.me/DevEviI)"
